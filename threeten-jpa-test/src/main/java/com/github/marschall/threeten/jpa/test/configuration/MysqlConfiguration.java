...
public class MysqlConfiguration {
  ...
  public DataSource dataSource() {
    ...
    dataSource.setUrl("jdbc:mysql://localhost:3306/" + database + "?useSSL=false&allowPublicKeyRetrieval=true&serverTimezone=UTC&logger=com.mysql.cj.log.Slf4JLogger&disableMariaDbDriver=true");
