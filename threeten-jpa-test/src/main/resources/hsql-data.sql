...
VALUES(
    1,
    CAST('1960-01-01 23:03:20.123456789+02:30' AS TIMESTAMP WITH TIME ZONE) + INTERVAL '2:30' HOUR TO MINUTE);
...
VALUES(
    2,
    CAST('1999-01-23 08:26:56.123456789-05:30' AS TIMESTAMP WITH TIME ZONE) - INTERVAL '5:30' HOUR TO MINUTE);
