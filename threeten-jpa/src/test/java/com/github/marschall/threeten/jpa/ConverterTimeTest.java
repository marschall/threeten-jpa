...
import com.github.marschall.threeten.jpa.entity.JavaTime42;
...
public class ConverterTimeTest {
  ...
  public void read(Class<?> datasourceConfiguration, Class<?> jpaConfiguration, String persistenceUnitName, TemporalUnit resolution) {
    ...
    try {
      ...
      this.template.execute(status -> {
        ...
        JavaTime42 javaTime = resultList.get(0);
