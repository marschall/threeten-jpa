...
public class ConverterTimestampTest {
  ...
  public static List<Arguments> parameters() {
    ...
    if (!isTravis()) {
      ...
      parameters.add(Arguments.of(OracleConfiguration.class, EclipseLinkConfiguration.class, "threeten-jpa-eclipselink-oracle", ChronoUnit.NANOS));
    }
...
//      parameters.add(Arguments.of(FirebirdConfiguration.class, HibernateConfiguration.class, "threeten-jpa-hibernate-firebird", ChronoUnit.MILLIS));
      ...
      parameters.add(Arguments.of(OracleConfiguration.class, HibernateConfiguration.class, "threeten-jpa-hibernate-oracle", ChronoUnit.NANOS));
    }
